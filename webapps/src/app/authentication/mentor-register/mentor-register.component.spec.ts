...
describe('MentorRegisterComponent', () => {
  ...
  it('Submitting The Form',()=>{
    ...
    component.signupForm.controls['linkedInUrl'].setValue('Book');
    component.signupForm.controls['experience'].setValue(3);
    component.signupForm.controls['image'].setValue('adsjhfjklasdhfjklahsdfjklh');
...
it('Submitting The Form',()=>{
  ...
  component.mentorForm.controls['trainings'].setValue(3);
  component.mentorForm.controls['facilities'].setValue('Book');
  component.mentorForm.controls['rating'].setValue(9);
  component.mentorForm.controls['skillName'].setValue('Book');
  component.mentorForm.controls['experience'].setValue(3);
  expect(component.mentorForm.valid).toBeTruthy();
//  component.onSubmitSignUp();
});
