...
public class TechnologyController {
	...
	@GetMapping("/{tech}")
	public Technology getTechnology(@Valid @PathVariable("tech") String name) {
	...
	@PostMapping("")
	public void postTechnology(@Valid @RequestBody Technology technology) {
		technologyService.saveTechnology(technology);
	}
	
	@DeleteMapping("/{name}")
	public void deleteTechnology(@Valid @PathVariable("name") String technologyName) {
