...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(router, mentorDetailSerivces, authService) {
                    this.router = router;
                ...
                AppComponent.prototype.ngOnInit = function () {
                    ...
                    this.mentorDetailSerivces.getAllmentorDetails().subscribe(function (data) {
                        _this.originalLists = data;
                    });
                    this.filteredList = this.originalLists;
                };
                AppComponent.prototype.search = function (event) {
                    var _this = this;
                    this.filteredList = this.originalLists.filter(function (food) { return food.technologies.name.toLocaleLowerCase().includes(_this.searchKey.toLocaleLowerCase()); });
                    this.mentorDetailSerivces.getSubject().next(this.filteredList);
                };
                AppComponent.prototype.isMentor = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApprovalComponent = /** @class */ (function () {
                function ApprovalComponent(mentroDetails, authService) {
                ...
                ApprovalComponent.prototype.approve = function (training) {
                    var _this = this;
                    this.mentroDetails.update(training.id, 'A').subscribe(function (data) {
                        console.log(data);
                        _this.fetchdata();
                    });
                };
                ApprovalComponent.prototype.deny = function (training) {
                    var _this = this;
                    this.mentroDetails.update(training.id, 'D').subscribe(function (data) {
                        console.log(data);
                        _this.fetchdata();
                    });
                };
                ApprovalComponent.prototype.fetchdata = function () {
                    var _this = this;
                    this.mentroDetails.getMentorRequests(this.authService.username, 'P').subscribe(function (data) {
                        _this.trainingList = data;
                    });
                };
                return ApprovalComponent;
            }());
            ApprovalComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.onSubmit = function (form) {
                    ...
                    this.authenticationService.authenticate(username, password).subscribe(function (data) {
                        console.log(data);
                        _this.authenticationService.loggedIn = true;
                        if (data.Role == 'Mentor') {
                            _this.authenticationService.isMentor = true;
                            _this.authenticationService.username = data.Username;
                            _this.router.navigate(['/profile']);
                        }
                        else if (data.Role == 'Student') {
                            _this.authenticationService.isStudent = true;
                            _this.authenticationService.username = data.Username;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MentorRegisterComponent = /** @class */ (function () {
                function MentorRegisterComponent(registrationService, router) {
                ...
                MentorRegisterComponent.prototype.matchConfirmPassword = function (formControl) {
                    if (this.signupForm) {
                ...
                MentorRegisterComponent.prototype.onSubmitSignUp = function () {
                    console.log(this.signupForm.value);
                    this.data = true;
                    this.mentorName = this.signupForm.get('userName').value;
                    this.registrationService.addMentorDetails(this.signupForm.value).subscribe(function (data) {
                        console.log(data);
                    });
                };
                MentorRegisterComponent.prototype.onSubmitmentorSkill = function () {
                    var _this = this;
                    var skill = {};
                    ...
                    setTimeout(function () {
                        _this.skillAdded = false;
                    }, 1000);
                    console.log(skill.skillName);
                    console.log(this.mentorForm.value);
                    this.registrationService.addMentorSkills(this.mentorForm.value, this.mentorName, skill.skillName).subscribe(function (data) {
                        console.log(data);
                        _this.signUp = data;
                    });
                    this.mentorForm.reset();
                };
                MentorRegisterComponent.prototype.loggedIn = function () {
                    if (this.signUp) {
            ...
            MentorRegisterComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StudentRegistrationComponent = /** @class */ (function () {
                function StudentRegistrationComponent(registrationService, router) {
                    this.registrationService = registrationService;
                    this.router = router;
                    this.signUp = false;
                }
                ...
                StudentRegistrationComponent.prototype.matchConfirmPassword = function (formControl) {
                    if (this.signupForm) {
                        if (formControl.value && formControl.value.length > 0 && formControl.value !== this.signupForm.get('password').value) {
                            return { 'nomatch': true };
                        }
                ...
                StudentRegistrationComponent.prototype.onSubmitSignUp = function () {
                    var _this = this;
                    console.log(this.signupForm.value);
                    this.registrationService.addStudentDetails(this.signupForm.value).subscribe(function (data) {
                        console.log(data);
                        _this.signUp = data;
                    });
                };
                StudentRegistrationComponent.prototype.loggedIn = function () {
                    if (this.signUp) {
                        this.router.navigate(['/login']);
                    }
                };
            ...
            StudentRegistrationComponent.ctorParameters = function () { return [
                { type: src_app_services_registration_service__WEBPACK_IMPORTED_MODULE_3__["RegistrationService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MentorInfoComponent = /** @class */ (function () {
                function MentorInfoComponent(authService, mentorService) {
                    this.authService = authService;
                    this.mentorService = mentorService;
                    this.userId = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                MentorInfoComponent.prototype.ngOnInit = function () {
                };
                MentorInfoComponent.prototype.isStudent = function () {
                    return this.authService.isStudent;
                };
                MentorInfoComponent.prototype.isMentor = function () {
                    return this.authService.isMentor;
                };
                MentorInfoComponent.prototype.book = function (userName, technologyName) {
                    console.log(this.authService.username + " " + userName + "  " + technologyName);
                    return this.mentorService.book(this.authService.username, userName, technologyName).subscribe(function (data) {
                        console.log(data);
                    });
                };
                return MentorInfoComponent;
            }());
            MentorInfoComponent.ctorParameters = function () { return [
                { type: src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MentorListComponent = /** @class */ (function () {
                function MentorListComponent(mentordetailsService) {
                    this.mentordetailsService = mentordetailsService;
                }
                MentorListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.mentordetailsService.getAllmentorDetails().subscribe(function (data) {
                        console.log(data);
                        _this.mentorDetails = data;
                    });
                    this.mentordetailsService.getSubject().subscribe(function (data) {
                        _this.originalList = __spread(data);
                        _this.mentorDetails = __spread(data);
                    });
                    this.mentordetailsService.filter.subscribe(function (obj) {
                        if (obj.name !== '') {
                            var result = _this.originalList.filter(function (prod) { return prod.technologies.name.toLowerCase().includes(obj.name.toLowerCase()); });
                            _this.mentorDetails = result ? result : [];
                        }
                        else {
                            _this.mentorDetails = __spread(_this.originalList);
                        }
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_mentor_details_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/mentor-details.service */ "./src/app/services/mentor-details.service.ts");
            /* harmony import */ var _services_authentication_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/authentication.service */ "./src/app/services/authentication.service.ts");
            var MentorProgressComponent = /** @class */ (function () {
                function MentorProgressComponent(mentoDetailService, authService) {
                    this.mentoDetailService = mentoDetailService;
                    this.authService = authService;
                    this.isButton = false;
                    this.status = false;
                }
                MentorProgressComponent.prototype.ngOnInit = function () {
                    this.fetchData();
                };
                MentorProgressComponent.prototype.submit = function () {
                    var _this = this;
                    this.mentoDetailService.updateProgress(this.authService.username, 'A').subscribe(function (data) {
                        console.log(data);
                        _this.fetchData();
                    });
                };
                MentorProgressComponent.prototype.fetchData = function () {
                    var _this = this;
                    this.mentoDetailService.getCurrentMentorCourses(this.authService.username).subscribe(function (data) {
                        var e_1, _a, e_2, _b;
                        console.log(data);
                        _this.training = data;
                        try {
                            for (var _c = __values(_this.training), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var p = _d.value;
                        ...
                        if (_this.training != [] && _this.status) {
                            _this.isButton = true;
                            _this.mentoDetailService.getTableOfContents(_this.authService.username, _this.getStatus).subscribe(function (data) {
                                console.log(data);
                                _this.contents = data;
                            });
                        }
                        try {
                            for (var _e = __values(_this.training), _f = _e.next(); !_f.done; _f = _e.next()) {
                                var p = _f.value;
                                if (p.status == 'C' || p.status == 'P') {
                                    _this.isButton = false;
                                    _this.status = true;
                                    console.log(_this.isButton);
                                }
                                if (p.status == 'A') {
                                    _this.isButton = true;
                                    _this.status = true;
                ...
                return MentorProgressComponent;
            }());
            MentorProgressComponent.ctorParameters = function () { return [
                { type: _services_mentor_details_service__WEBPACK_IMPORTED_MODULE_2__["MentorDetailsService"] },
                { type: _services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(mentorDetailService, authService) {
                    this.mentorDetailService = mentorDetailService;
                    this.authService = authService;
                }
                ProfileComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.mentorDetailService.getMentorDetail(this.authService.username).subscribe(function (data) {
                        console.log(data);
                        _this.detail = data;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProgressComponent = /** @class */ (function () {
                function ProgressComponent(mentoDetailService, authService) {
                    this.mentoDetailService = mentoDetailService;
                    this.authService = authService;
                }
                ProgressComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.mentoDetailService.getCurrentCourses(this.authService.username).subscribe(function (data) {
                        console.log(data);
                        _this.training = data;
                    });
                };
                ProgressComponent.prototype.onSubmit = function (form, id) {
                    var rating = form.value.rating;
                    console.log(rating + "  " + id);
                    this.mentoDetailService.updateRating(id, rating).subscribe(function (data) {
                        console.log(data);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                ...
                AuthenticationService.prototype.authenticate = function (username, password) {
                    ...
                    console.log(headers);
                    return this.httpClient.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].mentorUrl + 'authentication-service/authenticate', { headers: headers });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
            var MentorDetailsService = /** @class */ (function () {
                function MentorDetailsService(httpClient) {
                    this.httpClient = httpClient;
                    this.filter = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
                    this.subject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
                }
                MentorDetailsService.prototype.getAllmentorDetails = function () {
                ...
                MentorDetailsService.prototype.getSubject = function () {
                    return this.subject;
                };
                MentorDetailsService.prototype.getMentorDetail = function (username) {
                ...
                MentorDetailsService.prototype.book = function (studentName, mentoName, technologyName) {
                ...
                MentorDetailsService.prototype.getMentorRequests = function (mentorName, status) {
                ...
                MentorDetailsService.prototype.update = function (id, status) {
                ...
                MentorDetailsService.prototype.getStudentRequests = function (studentName) {
                ...
                MentorDetailsService.prototype.getCurrentCourses = function (username) {
                ...
                MentorDetailsService.prototype.getCurrentMentorCourses = function (username) {
                ...
                MentorDetailsService.prototype.getTableOfContents = function (username, status) {
                ...
                MentorDetailsService.prototype.updateProgress = function (username, status) {
                ...
                MentorDetailsService.prototype.updateRating = function (trainingId, rating) {
                ...
                return MentorDetailsService;
            }());
            MentorDetailsService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegistrationService = /** @class */ (function () {
                ...
                RegistrationService.prototype.addMentorDetails = function (mentorDetails) {
                ...
                RegistrationService.prototype.addMentorSkills = function (mentorSkills, mentorName, technologyName) {
                ...
                RegistrationService.prototype.addStudentDetails = function (studentDetails) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _services_mentor_details_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/mentor-details.service */ "./src/app/services/mentor-details.service.ts");
            /* harmony import */ var _services_authentication_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/authentication.service */ "./src/app/services/authentication.service.ts");
            var StudentApprovalComponent = /** @class */ (function () {
                function StudentApprovalComponent(mentorDetailService, authservice) {
                    this.mentorDetailService = mentorDetailService;
                    this.authservice = authservice;
                }
                StudentApprovalComponent.prototype.ngOnInit = function () {
                    this.fetchdata();
                };
                StudentApprovalComponent.prototype.fetchdata = function () {
                    var _this = this;
                    this.mentorDetailService.getStudentRequests(this.authservice.username).subscribe(function (data) {
                        _this.trainingList = data;
                        console.log(data);
                    });
                };
                return StudentApprovalComponent;
            }());
            StudentApprovalComponent.ctorParameters = function () { return [
                { type: _services_mentor_details_service__WEBPACK_IMPORTED_MODULE_2__["MentorDetailsService"] },
                { type: _services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticationService"] }
            ]; };
