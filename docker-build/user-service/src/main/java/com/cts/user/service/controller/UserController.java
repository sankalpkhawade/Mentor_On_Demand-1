...
public class UserController {
	...
	public void giveProposal(@Valid @PathVariable("userName") String userName,@Valid @PathVariable("mentorName") String mentorName,
	...
	public List<Training> getMentorProposal(@Valid @PathVariable("mentorName") String mentorName,
			@PathVariable("status") String status) {
		return mentorDetailsService.getProposal(mentorName, status);
	}

	@PutMapping("/{trainingId}/{status}")
	public void updateProposal(@Valid @PathVariable("trainingId") int trainingId, @PathVariable("status") String status) {
		mentorDetailsService.updateProposal(trainingId, status);
	}

	@GetMapping("/student/{studentName}")
	public List<Training> getStudentProposal(@Valid @PathVariable("studentName") String studentName) {
