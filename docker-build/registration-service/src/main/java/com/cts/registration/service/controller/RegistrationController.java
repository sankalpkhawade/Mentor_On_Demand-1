...
public class RegistrationController {
	...
	public boolean mentorSkillsRegistration(@Valid @RequestBody MentorSkills mentorSkills,
			@Valid @PathVariable("mentor") String userName,@Valid @PathVariable("technology") String technologyName) {
	...
	public void mentorSkills(@Valid @RequestBody Set<MentorSkills> mentorSkillsSet) {
	...
	@PostMapping("/student")
	public boolean studentRegistration(@Valid @RequestBody StudentDetails studentDetails) {
	...
	@PutMapping("/mentor/skills/{mentor}/{technology}")
    public boolean mentorSkills(@Valid @RequestBody MentorSkills mentorSkills, @Valid @PathVariable("mentor") String userName,
    		@Valid @PathVariable("technology") String technologyName) {
           return mentorSkillsService.updateSkills(mentorSkills, userName, technologyName);
    }
    
    @GetMapping("/mentor/skills/{id}")
    public MentorSkills editMentorSkills(@Valid @PathVariable("id") int id) {
           return mentorSkillsService.editMentorSkills(id);
    }
