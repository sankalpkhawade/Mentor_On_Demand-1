...
public class SearchController {
	...
	public List<MentorSkills> searchMentor(@Valid @PathVariable("technologyName") String technologyName) {
...
//	}
    ...
    public List<MentorSkills> getMentorDetail(@Valid @PathVariable("mentorName") String mentorName) {
