	------------------------------------------------------------------------	
	------------------------Mentor_On_Deamnd Execution Steps--------------------------------
	------------------------------------------------------------------------
...
Step2: Execute the Schema Present in project and excute the Following SQL Command
...
Step: 4
	Execute the Angular Code 
	
	--  npm install for node_modules file
	--  ng serve for running angular project

	Please Refer few More Screen Shots in Application and JMeter,Karma Testing
