...
public class TrainingController {
	...
	@GetMapping("/mentor/current/{mentorName}")
	public List<Training> getCurrentTraining(@PathVariable("mentorName") String mentorName) {
		return trainingService.getCurrentTraining(mentorName);
	}
