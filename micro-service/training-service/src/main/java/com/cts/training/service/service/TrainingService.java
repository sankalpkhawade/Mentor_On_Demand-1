...
public class TrainingService {
	...
	public List<Training> getCurrentTraining(String mentorName) {
		return trainingRepository.findByMentorDetails(mentorDetailsRepository.findByUserName(mentorName));
	}
