...
public class TechnologyServiceApplicationTests {
	...
	public void testsaveFailure() {
		...
		when(technologyRepositry.findByName("SAP")).thenReturn(technology);
		Technology testTech = technologyRepositry.findByName("SAP");
		assertEquals("SAAP", testTech.getName());
	}
	...
	@Test
	public void testgetTechnologyFailure() {
		Technology technology = new Technology();
		technology.setId(1);
		technology.setDuration(2);
		technology.setName("SAP");
		...
		Technology testTech = technologyRepositry.findByName("SAP");
		assertEquals("SAAP", testTech.getName());
		assertEquals("Boooks", testTech.getPrerequisites());
	}
	...
	@Test
	public void testgetAllTechnologyFailure() {
		Technology technology = new Technology();
		technology.setId(1);
		technology.setDuration(2);
		technology.setName("SAP");
		...
		for (Technology tech : testTech) {
			assertEquals("SAAP", tech.getName());
			assertEquals("Boooks", tech.getPrerequisites());
		}
	}
